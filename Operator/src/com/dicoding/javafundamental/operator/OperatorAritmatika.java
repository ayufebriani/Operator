...
public class OperatorAritmatika {
      public static void main(String[] args) {
        ...
        System.out.println("Hasil 7 + 1 = " + hasilPenjumlahan);
        System.out.println();
        System.out.println("Operasi Pengurangan");
        int hasilPengurangan = 4 - 1;
        System.out.println("Hasil 4 - 2 = " + hasilPengurangan);
        System.out.println();
        System.out.println("Operasi Pengalian");
        int hasilPengalian = 5 * 5;
        System.out.println("Hasil 8 * 5 = " + hasilPengalian);
        System.out.println();
        System.out.println("Operasi Pembagian");
        int hasilPembagian = 20 / 2;
        System.out.println("Hasil 20 / 10 = " + hasilPembagian);
        System.out.println();
